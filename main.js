...
document.getElementById('q5').innerHTML += "<p>FOR:</p>";
for (i = 10; i <= 110; i += 25) {
    document.getElementById('q5').innerHTML += "<p>At home, I have " + i + " cats.</p>";
}

document.getElementById('q5').innerHTML += "WHILE:";
var i = 10;
...
//I was stuck for a while and I had to look at the solutiions for this one
var numThrees = [];
...
//I had to cheat and look at solutions to figure out the #
var hash = "";

for( i=0; i<= 8; i++) {
    hash += '#'
         document.getElementById('q8').innerHTML += "<p>" + i + "</p>";
 }
